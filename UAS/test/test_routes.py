...
def create_test_cart(cart_id):
    cart = Cart(id=cart_id, coupon_code='COUPON_CUY', shipping_fee=40000, subtotal=60000, grand_total=100000)
    cart_item = CartItem(product_id=1, qty=2, item_price=100000)
